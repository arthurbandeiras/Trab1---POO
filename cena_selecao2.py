...
class CenaSelection2:
    ...
    def desenha(self):
        x = (ConfigJogo.LARGURA_TELA//2) - 0.2*ConfigJogo.LARGURA_TELA
        y = (ConfigJogo.ALTURA_TELA//2) - 0.30*ConfigJogo.ALTURA_TELA
        l = 0.4*ConfigJogo.LARGURA_TELA
        ...
        x_selectbox = (ConfigJogo.LARGURA_TELA//2) - 0.18*ConfigJogo.LARGURA_TELA
        y_selectbox = self.rect_sel
        l_selectbox = 0.36*ConfigJogo.LARGURA_TELA
    ...
    def desenha_selection1(self,tela):
        ...
        py = (0.27 * ConfigJogo.ALTURA_TELA // 2) + \
